...
<body class="tajawal-medium">
  @if (auth()->check())
    ...
    <div class="offcanvas-body">
      ...
      <div class="list-group list-group-flush" style="text-align: center; border: 1px solid #ccc;">
      <li class="list-group-item tajawal-bold card-header custom-card-header">الصفحات</li>
      <a href="/" class="list-group-item list-group-item-action">الصفحة الرئيسية</a>
      </div>
      <br>

      <div class="list-group list-group-flush" style="text-align: center; border: 1px solid #ccc;">
      <li class="list-group-item tajawal-bold card-header custom-card-header">العمليّات</li>
      ...
      <br>
      <div class="list-group list-group-flush" style="text-align: center; border: 1px solid #ccc;">
      <li class="list-group-item tajawal-bold card-header custom-card-header">الحساب</li>
      <a href="/profile" class="list-group-item list-group-item-action">حسابي</a>
      <a href="/terms" class="list-group-item list-group-item-action">الشروط والأحكام</a>
